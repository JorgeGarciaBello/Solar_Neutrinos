subroutine chartPem()
    ...
    print*,'ChartPem'
    open(29,file='results/chartPem.dat')
    do k=1,10000
        Ne = Ne + jump
        write(29,*) matterDensity(nu,Ne), real(probabilityOfTransitionAB(1,2,L,t12,t23,t13,delta,sm,aM,P,nu,Ne))
    enddo
    close(29)
    return
end subroutine chartPem